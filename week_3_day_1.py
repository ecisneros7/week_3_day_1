...
print("Once upon a time, there was a " + str(age) + " year old boy named " + name + " whose favorite song is " + song + " and his favorite food is " + food + " and his favorite number was " + str(number) + ".")
...
number4 = 400
number5 = 500
#put all into a sentence
# print("I have " + str(number1) + " dollars, " + str(number2) + " marbles, " + str(number3) + " coins, " + str(number4) + " pencils, and " + str(number5) + " sheets of paper.")
#f strings
...
print(max(1,2)) #max number get the largeest number
